...
./jfrog rt u "ugs-platform/application/target/win64-ugs-platform-app-*.zip" "/UGS/$1/ugs-platform-app-win64.zip" --build-name=$ARTIFACTORY_NAME --build-number=$TRAVIS_BUILD_NUMBER -flat=true
