...
import com.willwinder.universalgcodesender.firmware.grblhal.commands.GrblHalCommand;
 ...
 */
public class GrblHalCommandCreator implements ICommandCreator {
    @Override
    public GcodeCommand createCommand(String command) {
        return new GrblHalCommand(command);
    }

    @Override
    public GcodeCommand createCommand(String command, String originalCommand, String comment, int lineNumber) {
        return new GrblHalCommand(command, originalCommand, comment, lineNumber);
    }
}
