...
/**
 * A command which will either get current config filename 
 */
public class GetCurrentConfigFilename extends GcodeCommand {
    
    public GetCurrentConfigFilename() {
    ...
    public String GetFilename() {
        String configToUse = getResponse();
        if (configToUse != null) {
