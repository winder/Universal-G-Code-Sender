...
/**
 * An event that will be dispatched on stream events such as when a file stream is started, paused or cancelled.
 *
 * @author Joacim Breiler
 */
public class StreamEvent implements UGSEvent {
