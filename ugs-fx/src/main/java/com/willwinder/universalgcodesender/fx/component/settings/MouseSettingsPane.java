...
public class MouseSettingsPane extends BorderPane {

    private final VBox settingsGroup;

    public MouseSettingsPane() {
        addTitleSection();
    ...
    private void addMouseControls() {
        ...
        settingsGroup.getChildren().add(mouseControls);
    }

    private void addTitleSection() {
        Label title = new Label(Localization.getString("settings.mouse"));
