...
public class DesignUndoAction extends AbstractDesignEditAction implements UndoManagerListener {
    public static final String ICON_BASE = "icons/undo.svg";
    ...
    public void onChanged() {
        setEnabledLater(undoManager.canUndo());
    }
}
