...
public class Extrusion2040 extends Group {
    private static final Logger LOGGER = Logger.getLogger(Extrusion4040.class.getName());

    public Extrusion2040(double length) {
        try {
            URI uri = Objects.requireNonNull(getClass().getResource("/model/tslot-2040.svg")).toURI();
