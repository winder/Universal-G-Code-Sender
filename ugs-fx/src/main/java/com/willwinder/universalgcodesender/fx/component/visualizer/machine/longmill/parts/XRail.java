...
public class XRail extends Group {
    private static final Logger LOGGER = Logger.getLogger(XRail.class.getName());

    public XRail(double length) {
        try {
            URI uri = Objects.requireNonNull(getClass().getResource("/model/longmill/xrail.svg")).toURI();
