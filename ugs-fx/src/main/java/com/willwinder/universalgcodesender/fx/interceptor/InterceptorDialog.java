 ...
 * screens for the different interceptor states. All methods are called on the JavaFX application thread.
 *
...
public interface InterceptorDialog {
    ...
    /**
     * Handles a state change of the command interceptor service.
     *
    ...
    /**
     * Handles a state change of the controller so the dialog can enable or disable its controls.
     *
     * @param event the controller state event
     */
    void handleControllerState(ControllerStateEvent event);
}
