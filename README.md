...
![Console during a file send](pictures/console_tab.png "Console during a file send.")
![Command table tab during a file send](pictures/command_table_tab.png "Command table tab during a file send.")
