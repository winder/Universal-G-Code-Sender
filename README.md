...
For development we use [Maven](http://maven.apache.org) and [Java](https://adoptium.net/) for compiling. We rely on a specific version of Java 17 and is needed due to some of the libraries we depend on.
