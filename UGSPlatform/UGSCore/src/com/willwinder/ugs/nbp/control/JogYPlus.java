...
@ActionID(
        category = "Machine",
        id = "com.willwinder.ugs.nbp.control.JogYPlus"
)
@ActionRegistration(
...
public class JogYPlus extends AbstractAction implements ContextAwareAction {
    JogService jogService;

    public JogYPlus() {
        jogService = Lookup.getDefault().lookup(JogService.class);
        putValue(Action.NAME, org.openide.util.NbBundle.getMessage(JogService.class, "JogService.yPlus")); // NOI18N
    }
