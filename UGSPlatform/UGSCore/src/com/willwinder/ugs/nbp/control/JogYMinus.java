...
@ActionID(
        category = "Machine",
        id = "com.willwinder.ugs.nbp.control.JogYMinus"
)
@ActionRegistration(
...
public class JogYMinus extends AbstractAction implements ContextAwareAction {
    JogService jogService;

    public JogYMinus() {
        jogService = Lookup.getDefault().lookup(JogService.class);
        putValue(Action.NAME, org.openide.util.NbBundle.getMessage(JogService.class, "JogService.yMinus")); // NOI18N
    }
    
    @Override
    public Action createContextAwareInstance(Lookup lkp) {
        return new JogYMinus();
    }
