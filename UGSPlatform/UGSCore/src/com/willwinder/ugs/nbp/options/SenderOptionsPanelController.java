...
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_Sender=Sender", "AdvancedOption_Keywords_Sender=one,two,three"})
public final class SenderOptionsPanelController extends OptionsPanelController {
