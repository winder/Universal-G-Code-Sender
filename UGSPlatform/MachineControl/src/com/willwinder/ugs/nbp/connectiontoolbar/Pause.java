...
@ActionID(
        category = "Edit",
        id = "com.willwinder.ugs.nbp.connectiontoolbar.Pause"
)
@ActionRegistration(
        displayName = "#CTL_Pause",
        lazy = false
)
@ActionReference(path = "Toolbars/StartPauseStop", position = 12)
@Messages("CTL_Pause=Pause")
public final class Pause extends AbstractAction implements ContextAwareAction, ControlStateListener {
    BackendAPI backend;
    ...
    public Pause(Lookup lookup) {
        Icon icon = ImageUtilities.image2Icon(
        ImageUtilities.loadImage("resources/16x16-pause.png"));
    ...
    public Action createContextAwareInstance(Lookup actionContext) {
        return new com.willwinder.ugs.nbp.connectiontoolbar.Stop(actionContext);
    }
