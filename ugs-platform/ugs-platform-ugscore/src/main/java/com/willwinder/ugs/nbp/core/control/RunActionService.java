    ...
    final public void initActions() {
        ...
        try {
            ...
            ars.registerAction(Localization.getString("mainWindow.swing.returnToZeroButton"),
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.RETURN_TO_ZERO));
            ars.registerAction(Localization.getString("mainWindow.swing.softResetMachineControl"),
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.ISSUE_SOFT_RESET));
            ars.registerAction(Localization.getString("mainWindow.swing.resetCoordinatesButton"),
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.RESET_COORDINATES_TO_ZERO));
            ars.registerAction("$X",
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.KILL_ALARM_LOCK));
            ars.registerAction("$C",
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.TOGGLE_CHECK_MODE));
            ars.registerAction("$G",
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.REQUEST_PARSER_STATE));
            ars.registerAction(Localization.getString("mainWindow.swing.homeMachine"),
                    machine, null , menuPath, new GcodeAction(this, ACTIONS.HOMING_CYCLE));
