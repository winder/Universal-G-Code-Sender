 ...
 * @author wwinder
 */
public class UGSControllerOptionPanel extends UGSOptionsPanel {
    public UGSControllerOptionPanel(AbstractOptionsPanelController controller) {
        super(controller);
    }

    @Override
    protected AbstractUGSSettings initPanel(IChanged changer) {
        return new ControllerProcessorSettingsPanel(settings, changer, FirmwareUtils.getConfigFiles());
    }
}
