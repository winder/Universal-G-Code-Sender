...
public class WwfreebieSource implements ClipartSource {
    ...
    public WwfreebieSource() {
        ...
        cliparts.add(new FontClipart("sign", Category.SIGNS_AND_SYMBOLS, font, "6"));
        cliparts.add(new FontClipart("sign", Category.SIGNS_AND_SYMBOLS, font, "7"));
        cliparts.add(new FontClipart("sign", Category.SIGNS_AND_SYMBOLS, font, "8"));
        cliparts.add(new FontClipart("sign", Category.SIGNS_AND_SYMBOLS, font, "9"));
