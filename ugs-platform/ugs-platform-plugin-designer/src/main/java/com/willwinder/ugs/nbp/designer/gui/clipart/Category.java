...
public enum Category {
    ...
    COMPUTER("platform.plugin.designer.clipart.computer"),
    ...
    GEOGRAPHY("platform.plugin.designer.clipart.geography"),
    ...
    OFFICE("platform.plugin.designer.clipart.office"),
    PEOPLE("platform.plugin.designer.clipart.people"),
    ...
    SPECIAL("platform.plugin.designer.clipart.special"),
