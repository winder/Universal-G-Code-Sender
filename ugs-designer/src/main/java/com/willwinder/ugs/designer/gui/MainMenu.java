...
public class MainMenu extends JMenuBar {
    ...
    public MainMenu(MenuListener listener) {
        ...
        open.setAccelerator(KeyStroke.getKeyStroke(
                java.awt.event.KeyEvent.VK_O, InputEvent.CTRL_DOWN_MASK));
        newdrawing.setAccelerator(KeyStroke.getKeyStroke(
                java.awt.event.KeyEvent.VK_N, InputEvent.CTRL_DOWN_MASK));
        undo.setAccelerator(KeyStroke.getKeyStroke(
                java.awt.event.KeyEvent.VK_Z, InputEvent.CTRL_DOWN_MASK));
        quit.setAccelerator(KeyStroke.getKeyStroke(
                java.awt.event.KeyEvent.VK_Q, InputEvent.CTRL_DOWN_MASK));
        export.setAccelerator(KeyStroke.getKeyStroke(
                java.awt.event.KeyEvent.VK_E, InputEvent.CTRL_DOWN_MASK));
        saveas.setAccelerator(KeyStroke.getKeyStroke(
                java.awt.event.KeyEvent.VK_S, InputEvent.CTRL_DOWN_MASK));
