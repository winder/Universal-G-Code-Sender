...
//        mw.setSize(java.awt.GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().width, java.awt.GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().width);
    ...
    private void initComponents() {
        ...
        connectionStatusSplit = new javax.swing.JSplitPane();
        ...
        fileJogSplit = new javax.swing.JSplitPane();
        ...
        leftSplitPanel.setPreferredSize(new java.awt.Dimension(251, 700));

        connectionStatusSplit.setOrientation(javax.swing.JSplitPane.VERTICAL_SPLIT);
        connectionStatusSplit.setMinimumSize(new java.awt.Dimension(10, 10));
        connectionStatusSplit.setPreferredSize(new java.awt.Dimension(249, 320));
        ...
        connectionPanel.setPreferredSize(new java.awt.Dimension(247, 140));
        ...
        connectionStatusSplit.setLeftComponent(connectionPanel);
        ...
        connectionStatusSplit.setRightComponent(statusPanel);

        leftSplitPanel.setLeftComponent(connectionStatusSplit);

        fileJogSplit.setOrientation(javax.swing.JSplitPane.VERTICAL_SPLIT);
        fileJogSplit.setMaximumSize(new java.awt.Dimension(32767, 32767));
        fileJogSplit.setMinimumSize(new java.awt.Dimension(10, 10));
        fileJogSplit.setPreferredSize(new java.awt.Dimension(10, 10));
        ...
        fileJogSplit.setLeftComponent(fileModePanel);
        ...
        fileJogSplit.setRightComponent(keyboardMovementPanel);

        leftSplitPanel.setRightComponent(fileJogSplit);

        leftRightSplit.setLeftComponent(leftSplitPanel);

        rightSplitPanel.setOrientation(javax.swing.JSplitPane.VERTICAL_SPLIT);
        rightSplitPanel.setContinuousLayout(true);
        rightSplitPanel.setMinimumSize(new java.awt.Dimension(10, 10));
        rightSplitPanel.setPreferredSize(new java.awt.Dimension(10, 10));
        ...
        controlContextTabbedPane.setPreferredSize(new java.awt.Dimension(300, 220));
        ...
        machineControlPanel.setMinimumSize(new java.awt.Dimension(10, 10));
        ...
        rightSplitPanel.setLeftComponent(controlContextTabbedPane);

        lowerPanel.setPreferredSize(new java.awt.Dimension(10, 10));
        ...
        bottomTabbedPane.setPreferredSize(new java.awt.Dimension(468, 10000));

        commandsPanel.setMinimumSize(new java.awt.Dimension(10, 10));
        ...
        lowerPanelLayout.setVerticalGroup(
            ...
            .add(lowerPanelLayout.createSequentialGroup()
                .add(lowerPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    ...
                    .add(showCommandTableCheckBox))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(bottomTabbedPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        rightSplitPanel.setRightComponent(lowerPanel);

        leftRightSplit.setRightComponent(rightSplitPanel);
        ...
        layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, leftRightSplit, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 1230, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, leftRightSplit, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 744, Short.MAX_VALUE)
        );
...
//    }
    ...
    private javax.swing.JSplitPane connectionStatusSplit;
    ...
    private javax.swing.JSplitPane fileJogSplit;
