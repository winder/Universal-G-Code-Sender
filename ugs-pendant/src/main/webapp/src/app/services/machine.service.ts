...
export class MachineService {
    ...
    getSelectedBaudRate(): Observable<string> {
        return this.http.get<any>('/api/v1/machine/getSelectedBaudRate').pipe(map(baudRate => baudRate.selectedBaudRate));
    }
    ...
    getSelectedPort(): Observable<string> {
        return this.http.get<any>('/api/v1/machine/getSelectedPort').pipe(map(port => port.selectedPort));
    }
    ...
    getSelectedFirmware(): Observable<string> {
        return this.http.get<any>('/api/v1/machine/getSelectedFirmware').pipe(map(firmware => firmware.selectedFirmware));
    }
